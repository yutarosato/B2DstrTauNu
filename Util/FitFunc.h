...
Int_t iterative_fit( TH1D* hist, TF1* func, Int_t nparam, Double_t* init_var, const Char_t* opt_plot,                      Int_t max    );
Int_t iterative_fit( TH1D* hist, TF1* func, Int_t nparam, Double_t* init_var, const Char_t* opt_plot, fit_iter manip=NULL, Int_t max=20 );
...
// 33000. cb functione (bifurcated gaussian)
...
// 40002. cb functione (bifurcated gaussian) + gaussian + parabola
Double_t func_cb_bif_gauss_parabola(const Double_t* x, const Double_t*p);

// 40081. cb functione (bifurcated gaussian) + gaussian + threshold
