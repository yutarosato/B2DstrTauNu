...
//const Char_t* fl_par_pdf = "R2_0p400"; // for PDF // tmpppp
//const Char_t* fl_par_pdf = "S1_0p400"; // for PDF // tmpppp
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
///*
...
//const Char_t*  fl_par_dt       = "R2_0p000"; // for samples // tmpppppp
//const Char_t*  fl_par_dt       = "S1_0p000"; // for samples // tmpppppp
...
<<  }
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_nb, FillStyle(1001), FillColor( 7), DrawOption("F"), Components(RooArgSet(                   *pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9])) ); // fake D(*) // for paper plot (except other) // tmppppp
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_nb, FillStyle(1001), FillColor(15), DrawOption("F"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm
  pdf_tot->plotOn( frame_fit_nb, FillStyle(3017), FillColor(3), DrawOption("F"),  Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm

  pdf_tot->plotOn( frame_fit_nb, FillStyle(1001), FillColor(11), DrawOption("F"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
  pdf_tot->plotOn( frame_fit_nb, FillStyle(3006), FillColor(17), DrawOption("F"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_nb_sig_enh, FillStyle(1001), FillColor( 7), DrawOption("F"), ProjectionRange("signal_box_eecl"), Components(RooArgSet(                   *pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9])) ); // fake D(*) // for paper plot (except other) // tmppppp
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_nb_sig_enh, FillStyle(1001), FillColor(15), DrawOption("F"),  ProjectionRange("signal_box_eecl"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm
  pdf_tot->plotOn( frame_fit_nb_sig_enh, FillStyle(3017), FillColor(3), DrawOption("F"),  ProjectionRange("signal_box_eecl"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm

  pdf_tot->plotOn( frame_fit_nb_sig_enh, FillStyle(1001), FillColor(11), DrawOption("F"), ProjectionRange("signal_box_eecl"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
  pdf_tot->plotOn( frame_fit_nb_sig_enh, FillStyle(3006), FillColor(17), DrawOption("F"), ProjectionRange("signal_box_eecl"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_nb_sig_enh_log, FillStyle(1001), FillColor( 7), DrawOption("F"), Components(RooArgSet(                   *pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9])) ); // fake D(*) // for paper plot (except other) // tmppppp
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_nb_sig_enh_log, FillStyle(1001), FillColor(15), DrawOption("F"),  Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm
  pdf_tot->plotOn( frame_fit_nb_sig_enh_log, FillStyle(3017), FillColor(3), DrawOption("F"),  Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm

  pdf_tot->plotOn( frame_fit_nb_sig_enh_log, FillStyle(1001), FillColor(11), DrawOption("F"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
  pdf_tot->plotOn( frame_fit_nb_sig_enh_log, FillStyle(3006), FillColor(17), DrawOption("F"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_eecl, FillStyle(1001), FillColor( 7), DrawOption("F"), Components(RooArgSet(                   *pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9])) ); // fake D(*) // for paper plot (except other) // tmppppp
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_eecl, FillStyle(1001), FillColor(15), DrawOption("F"),  Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm
  pdf_tot->plotOn( frame_fit_eecl, FillStyle(3017), FillColor(3), DrawOption("F"),  Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm

  pdf_tot->plotOn( frame_fit_eecl, FillStyle(1001), FillColor(11), DrawOption("F"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
  pdf_tot->plotOn( frame_fit_eecl, FillStyle(3006), FillColor(17), DrawOption("F"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_eecl_sig_enh, FillStyle(1001), FillColor( 7), DrawOption("F"), ProjectionRange("signal_box_nb"), Components(RooArgSet(                   *pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9])) ); // fake D(*) // for paper plot (except other) // tmppppp
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_eecl_sig_enh, FillStyle(1001), FillColor(15), DrawOption("F"),  ProjectionRange("signal_box_nb"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm
  pdf_tot->plotOn( frame_fit_eecl_sig_enh, FillStyle(3017), FillColor(3), DrawOption("F"),  ProjectionRange("signal_box_nb"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm

  pdf_tot->plotOn( frame_fit_eecl_sig_enh, FillStyle(1001), FillColor(11), DrawOption("F"), ProjectionRange("signal_box_nb"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
  pdf_tot->plotOn( frame_fit_eecl_sig_enh, FillStyle(3006), FillColor(17), DrawOption("F"), ProjectionRange("signal_box_nb"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_eecl_nor_enh, FillStyle(1001), FillColor( 7), DrawOption("F"), ProjectionRange("norm_box_nb"), Components(RooArgSet(                   *pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9])) ); // fake D(*) // for paper plot (except other) // tmppppp
  ...
  */
  ...
  pdf_tot->plotOn( frame_fit_eecl_nor_enh, FillStyle(1001), FillColor(15), DrawOption("F"),  ProjectionRange("norm_box_nb"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm
  pdf_tot->plotOn( frame_fit_eecl_nor_enh, FillStyle(3017), FillColor(3), DrawOption("F"),  ProjectionRange("norm_box_nb"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3],*pdf_roohist_2d[2])) ); // norm

  pdf_tot->plotOn( frame_fit_eecl_nor_enh, FillStyle(1001), FillColor(11), DrawOption("F"), ProjectionRange("norm_box_nb"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
  pdf_tot->plotOn( frame_fit_eecl_nor_enh, FillStyle(3006), FillColor(17), DrawOption("F"), ProjectionRange("norm_box_nb"), Components(RooArgSet(*pdf_roohist_2d[0],*pdf_roohist_2d[5],*pdf_roohist_2d[6],*pdf_roohist_2d[7],*pdf_roohist_2d[8],*pdf_roohist_2d[9],*pdf_roohist_2d[4],*pdf_roohist_2d[3])) ); // D**
