...
const Char_t*  infile_dt       = "/home/belle/syutaro/dstrtaunu/modules/dstrtaunu/hbk/merge_nomddmcut/RD*.root";
const Bool_t   fl_use_dststmc  = true;
const Char_t*  infile_gmc      = "/home/belle/syutaro/dstrtaunu/modules/dstrtaunu/hbk/merge_nomddmcut/gMC_*s0[0-9]*.root";
const Double_t nstream_gmc     = 10;
const Char_t*  infile_dststmc  = "/home/belle/syutaro/dstrtaunu/modules/dstrtaunu/hbk/DssMC_weight_nb_nomddmcut/DssMC_*.root";
const Double_t nstream_dststmc = 2.7118;
const Bool_t   fl_use_npmc     = true;
const Char_t*  infile_npmc     = "/home/belle/syutaro/dstrtaunu/modules/dstrtaunu/hbk/0p0_weight_nb_nomddmcut/npMC_*s0*.root";
...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  */
  ...
  TH1D* eecl_hist_mc  = new TH1D(  "eecl_hist_mc",  "eecl_hist_mc", eecl_xbin, eecl_xmin, eecl_xmax );  eecl_hist_mc->Sumw2(); eecl_hist_mc->SetXTitle("E_{ECL} [GeV]");
  TH1D* eecl_hist_dt  = new TH1D(  "eecl_hist_dt",  "eecl_hist_dt", eecl_xbin, eecl_xmin, eecl_xmax );  eecl_hist_dt->Sumw2(); eecl_hist_dt->SetXTitle("E_{ECL} [GeV]");
  ...
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    for( Int_t ievt=0; ievt<c_gmc_cut->GetEntries(); ievt++ ){
      ...
      eecl_hist_mc ->Fill( c_gmc_cut->GetLeaf( eecl_brname)->GetValue(), weight );
    ...
    for( Int_t ievt=0; ievt<c_dststmc_cut->GetEntries(); ievt++ ){
      ...
      //weight *= 0.33478; // ~115.5/345 // tmppppppp
      nb_hist_mc   ->Fill( c_dststmc_cut->GetLeaf(   nb_brname)->GetValue(), weight );
      eecl_hist_mc ->Fill( c_dststmc_cut->GetLeaf( eecl_brname)->GetValue(), weight );
    ...
    for( Int_t ievt=0; ievt<c_npmc_cut->GetEntries(); ievt++ ){
      ...
      eecl_hist_mc ->Fill( c_npmc_cut->GetLeaf( eecl_brname)->GetValue(), weight );
...
//nb_hist_mc->SetBinContent( 2, 1.2*nb_hist_mc->GetBinContent(2) );
//nb_hist_mc->SetBinContent( nb_xbin, 0.9*nb_hist_mc->GetBinContent(nb_xbin) );
