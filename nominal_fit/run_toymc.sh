...
foreach CTGRY (sig nor dstst doubled other fake_sig fake_nor fake_dstst fake_doubled fake_other)
  grep -h HOGEEEE log/2dfit_*.log | grep "EE $CTGRY" > log/toymctest_${CTGRY}.dat
end
