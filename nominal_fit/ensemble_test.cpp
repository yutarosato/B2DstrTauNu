...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  TLine* mc_rdstr = new TLine( xmin, 0.2520,                        xmax, 0.2520                        ); mc_rdstr->SetLineColor(2); mc_rdstr->SetLineWidth(3);
  //TLine* mc_rdstr = new TLine( xmin, 0.2896,                        xmax, 0.2896                        ); mc_rdstr->SetLineColor(2); mc_rdstr->SetLineWidth(3); // Belle gMC value
  ...
  leg->AddEntry(  mc_rdstr, "MC expectation", "L" );
