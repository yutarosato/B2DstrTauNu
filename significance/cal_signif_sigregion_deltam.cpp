#include "cal_signif_sigregion_deltam.h"
...
Double_t cal_signif( TChain* chain, Double_t mass_L, Double_t mass_H, Double_t mass_L_slow, Double_t mass_H_slow, Bool_t fl_error ){
  ...
  if( fl_message && !fl_error ) std::cout << "nsig_true = "  << nsig_true  << ", "
					  << "nsig_false = " << nsig_false << ", "
					  << "nsig_cftau = " << nsig_cftau << std::endl
					  << "nnor_true = "  << nnor_true  << ", "
					  << "nnor_false = " << nnor_false << ", "
					  << "nother = "     << nother     << std::endl;
